...
import { DollarOutlined, FilePdfOutlined, CheckCircleOutlined } from '@ant-design/icons';
  ...
  return (
    <>
      <Form
        ...
        style={{ marginTop: 4 }}
        className={compact ? 'compact-medical-form compact-medical-editor' : 'compact-medical-form'}
      >
        <Row gutter={12}>
          <Col span={6}>
